...
public class BaiduBaikePageProcessor implements PageProcessor {
	...
	public void process(Page page) {
		...
		try {
			...
			FileOperate.WriteFile("baidu/baiduBaike-"+num, info);
			count ++;
    ...
    public static void main(String[] args) {
    	FileCacheQueueScheduler scheduler = new FileCacheQueueScheduler("baidu");
    	Spider spider = Spider.create(new BaiduBaikePageProcessor()).scheduler(scheduler);
    	Spider spider2 = Spider.create(new BaiduBaikePageProcessor()).scheduler(scheduler);
    	scheduler.push(new Request("http://baike.baidu.com/view/15707.htm"),spider);
    	scheduler.push(new Request("http://baike.baidu.com/view/14351.htm"),spider2);
    	spider.thread(5).run();
    	spider2.thread(5).run();
    	spider.stop();
    	spider2.stop();
    }
}
